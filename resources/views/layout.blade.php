...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <div class="container-fluid">
            <div class="row">
                <nav id="sidebar" class="col-md-3 col-lg-2 text-white bg-dark  sidebar">
                    <!-- contents -->
                    <div class="position-sticky ">
                        <ul class="nav flex-column text-white">
                            ...
                            <li class="nav-item">
                                <a class="nav-link  text-white" href="{{ route('testcase') }}">
                            ...
                            <li class="nav-item">
                                <a class="nav-link  text-white" href="{{ route('tasklist') }}">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit" class="btn btn-sm btn-primary" style="margin-left: 1.5em;">Logout</button>
                    </form>                
                </nav>
